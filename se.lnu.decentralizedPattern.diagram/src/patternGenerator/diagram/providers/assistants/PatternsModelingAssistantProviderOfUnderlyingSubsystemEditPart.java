 ...
 * @generated
 */
public class PatternsModelingAssistantProviderOfUnderlyingSubsystemEditPart
	...
	*/
	...
	public List<IElementType> getRelTypesOnTarget(IAdaptable target) {
		...
		return doGetRelTypesOnTarget((patternGenerator.diagram.edit.parts.UnderlyingSubsystemEditPart) targetEditPart);
	}
	...
	*/
	public List<IElementType> doGetRelTypesOnTarget(
			patternGenerator.diagram.edit.parts.UnderlyingSubsystemEditPart target) {
	...
	*/
	...
	public List<IElementType> getTypesForSource(IAdaptable target, IElementType relationshipType) {
		IGraphicalEditPart targetEditPart = (IGraphicalEditPart) target.getAdapter(IGraphicalEditPart.class);
		return doGetTypesForSource((patternGenerator.diagram.edit.parts.UnderlyingSubsystemEditPart) targetEditPart,
				relationshipType);
	}
	...
	*/
	public List<IElementType> doGetTypesForSource(
			patternGenerator.diagram.edit.parts.UnderlyingSubsystemEditPart target, IElementType relationshipType) {
