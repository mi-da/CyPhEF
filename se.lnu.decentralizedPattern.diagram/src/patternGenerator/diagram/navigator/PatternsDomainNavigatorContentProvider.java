 ...
 * @generated
 */
public class PatternsDomainNavigatorContentProvider implements ICommonContentProvider {
	...
	* @generated
	*/
	public PatternsDomainNavigatorContentProvider() {
	...
	*/
	public Object[] getChildren(Object parentElement) {
		...
		if (parentElement instanceof patternGenerator.diagram.navigator.PatternsDomainNavigatorItem) {
			return wrapEObjects(myAdapterFctoryContentProvier.getChildren(
					((patternGenerator.diagram.navigator.PatternsDomainNavigatorItem) parentElement).getEObject()),
					parentElement);
		}
		return EMPTY_ARRAY;
	}
	...
	public Object[] wrapEObjects(Object[] objects, Object parentElement) {
		...
		for (int i = 0; i < objects.length; i++) {
			if (objects[i] instanceof EObject) {
				result.add(new patternGenerator.diagram.navigator.PatternsDomainNavigatorItem((EObject) objects[i],
