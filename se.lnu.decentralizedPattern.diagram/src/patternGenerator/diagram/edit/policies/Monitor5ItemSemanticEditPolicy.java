 ...
 * @generated
 */
public class Monitor5ItemSemanticEditPolicy
		extends patternGenerator.diagram.edit.policies.PatternsBaseItemSemanticEditPolicy {

	/**
	* @generated
	*/
	public Monitor5ItemSemanticEditPolicy() {
		super(patternGenerator.diagram.providers.PatternsElementTypes.Monitor_3020);
	}
	...
	*/
	protected Command getDestroyElementCommand(DestroyElementRequest req) {
		...
		for (Iterator<?> it = view.getSourceEdges().iterator(); it.hasNext();) {
			...
			if (patternGenerator.diagram.part.PatternsVisualIDRegistry
					.getVisualID(outgoingLink) == patternGenerator.diagram.edit.parts.MonitorCheckEditPart.VISUAL_ID) {
