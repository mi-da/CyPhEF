 ...
 * @generated
 */
public class Execute4ItemSemanticEditPolicy
		extends patternGenerator.diagram.edit.policies.PatternsBaseItemSemanticEditPolicy {

	/**
	* @generated
	*/
	public Execute4ItemSemanticEditPolicy() {
		super(patternGenerator.diagram.providers.PatternsElementTypes.Execute_3019);
	}
	...
	*/
	protected Command getDestroyElementCommand(DestroyElementRequest req) {
		...
		for (Iterator<?> it = view.getSourceEdges().iterator(); it.hasNext();) {
			...
			if (patternGenerator.diagram.part.PatternsVisualIDRegistry
					.getVisualID(outgoingLink) == patternGenerator.diagram.edit.parts.ExecuteActEditPart.VISUAL_ID) {
