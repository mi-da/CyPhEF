 ...
 * @generated
 */
public class PeerItemSemanticEditPolicy
		extends patternGenerator.diagram.edit.policies.PatternsBaseItemSemanticEditPolicy {

	/**
	* @generated
	*/
	public PeerItemSemanticEditPolicy() {
		super(patternGenerator.diagram.providers.PatternsElementTypes.Peer_2004);
	}
	...
	*/
	protected Command getCreateCommand(CreateElementRequest req) {
		if (patternGenerator.diagram.providers.PatternsElementTypes.Monitor_3006 == req.getElementType()) {
			return getGEFWrapper(new patternGenerator.diagram.edit.commands.Monitor2CreateCommand(req));
		}
		if (patternGenerator.diagram.providers.PatternsElementTypes.Analyze_3007 == req.getElementType()) {
			return getGEFWrapper(new patternGenerator.diagram.edit.commands.Analyze2CreateCommand(req));
		}
		if (patternGenerator.diagram.providers.PatternsElementTypes.Plan_3008 == req.getElementType()) {
			return getGEFWrapper(new patternGenerator.diagram.edit.commands.Plan2CreateCommand(req));
		}
		if (patternGenerator.diagram.providers.PatternsElementTypes.Execute_3009 == req.getElementType()) {
			return getGEFWrapper(new patternGenerator.diagram.edit.commands.Execute2CreateCommand(req));
		}
		if (patternGenerator.diagram.providers.PatternsElementTypes.Knowledge_3010 == req.getElementType()) {
			return getGEFWrapper(new patternGenerator.diagram.edit.commands.Knowledge2CreateCommand(req));
		}
		...
		for (Iterator<?> nit = view.getChildren().iterator(); nit.hasNext();) {
			...
			case patternGenerator.diagram.edit.parts.Monitor2EditPart.VISUAL_ID:
				...
				for (Iterator<?> it = node.getSourceEdges().iterator(); it.hasNext();) {
					...
					if (patternGenerator.diagram.part.PatternsVisualIDRegistry.getVisualID(
							outgoingLink) == patternGenerator.diagram.edit.parts.MonitorCheckEditPart.VISUAL_ID) {
			...
			case patternGenerator.diagram.edit.parts.Execute2EditPart.VISUAL_ID:
				...
				for (Iterator<?> it = node.getSourceEdges().iterator(); it.hasNext();) {
					...
					if (patternGenerator.diagram.part.PatternsVisualIDRegistry.getVisualID(
							outgoingLink) == patternGenerator.diagram.edit.parts.ExecuteActEditPart.VISUAL_ID) {
						DestroyReferenceRequest r = new DestroyReferenceRequest(outgoingLink.getSource().getElement(),
								null, outgoingLink.getTarget().getElement(), false);
						cmd.add(new DestroyReferenceCommand(r));
						cmd.add(new DeleteCommand(getEditingDomain(), outgoingLink));
