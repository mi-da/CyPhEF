...
public class NodeEditPart extends ShapeNodeEditPart {
	...
	*/
	protected void createDefaultEditPolicies() {
		...
		installEditPolicy(EditPolicyRoles.SEMANTIC_ROLE,
				new patternGenerator.diagram.edit.policies.NodeItemSemanticEditPolicy());
		installEditPolicy(EditPolicyRoles.DRAG_DROP_ROLE, new DragDropEditPolicy());
		installEditPolicy(EditPolicyRoles.CANONICAL_ROLE,
				new patternGenerator.diagram.edit.policies.NodeCanonicalEditPolicy());
	...
	*/
	protected boolean addFixedChild(EditPart childEditPart) {
		if (childEditPart instanceof patternGenerator.diagram.edit.parts.NodeNameEditPart) {
			((patternGenerator.diagram.edit.parts.NodeNameEditPart) childEditPart)
	...
	*/
	...
	public class NodeFigure extends RoundedRectangle {
		...
		public NodeFigure() {
			...
			this.setMaximumSize(new Dimension(getMapMode().DPtoLP(160), getMapMode().DPtoLP(40)));
