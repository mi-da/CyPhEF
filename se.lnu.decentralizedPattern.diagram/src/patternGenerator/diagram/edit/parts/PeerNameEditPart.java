 ...
 * @generated
 */
public class PeerNameEditPart extends CompartmentEditPart implements ITextAwareEditPart {
	...
	* @generated
	*/
	public PeerNameEditPart(View view) {
		super(view);
	}
	...
	public IParser getParser() {
		if (parser == null) {
			parser = patternGenerator.diagram.providers.PatternsParserProvider.getParser(
					patternGenerator.diagram.providers.PatternsElementTypes.Peer_2004, getParserElement(),
