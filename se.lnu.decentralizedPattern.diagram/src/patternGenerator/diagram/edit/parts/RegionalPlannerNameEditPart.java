 ...
 * @generated
 */
public class RegionalPlannerNameEditPart extends CompartmentEditPart implements ITextAwareEditPart {
	...
	* @generated
	*/
	public RegionalPlannerNameEditPart(View view) {
		super(view);
	}
	...
	*/
	protected void createDefaultEditPolicies() {
		...
		installEditPolicy(EditPolicy.SELECTION_FEEDBACK_ROLE,
				new patternGenerator.diagram.edit.policies.PatternsTextSelectionEditPolicy());
	...
	*/
	public IParser getParser() {
		if (parser == null) {
			parser = patternGenerator.diagram.providers.PatternsParserProvider.getParser(
					patternGenerator.diagram.providers.PatternsElementTypes.RegionalPlanner_2005, getParserElement(),
	...
	protected DirectEditManager getManager() {
		if (manager == null) {
			setManager(new TextDirectEditManager(this, null,
					patternGenerator.diagram.edit.parts.PatternsEditPartFactory.getTextCellEditorLocator(this)));
		}
		return manager;
	}
