 ...
 * @generated
 */
public class PeerCreateCommand extends EditElementCommand {

	/**
	* @generated
	*/
	public PeerCreateCommand(CreateElementRequest req) {
	...
	*/
	protected CommandResult doExecuteWithResult(IProgressMonitor monitor, IAdaptable info) throws ExecutionException {
		patternGenerator.decentralizedPattern.Peer newElement = patternGenerator.decentralizedPattern.DecentralizedPatternFactory.eINSTANCE
				.createPeer();
	...
	* @generated
	*/
	protected void doConfigure(patternGenerator.decentralizedPattern.Peer newElement, IProgressMonitor monitor,
