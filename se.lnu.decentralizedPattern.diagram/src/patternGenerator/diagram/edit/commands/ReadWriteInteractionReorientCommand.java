 ...
 * @generated
 */
public class ReadWriteInteractionReorientCommand extends EditElementCommand {
	...
	* @generated
	*/
	public ReadWriteInteractionReorientCommand(ReorientRelationshipRequest request) {
	...
	*/
	public boolean canExecute() {
		if (false == getElementToEdit() instanceof patternGenerator.ReadWriteInteraction) {
			return false;
		}
	...
	*/
	protected boolean canReorientSource() {
		...
		return patternGenerator.diagram.edit.policies.PatternsBaseItemSemanticEditPolicy.getLinkConstraints()
				.canExistReadWriteInteraction_4006(container, getLink(), getNewSource(), target);
	}
	...
	*/
	protected boolean canReorientTarget() {
		...
		patternGenerator.DecentralizedControlPattern container = (patternGenerator.DecentralizedControlPattern) getLink()
				.eContainer();
		return patternGenerator.diagram.edit.policies.PatternsBaseItemSemanticEditPolicy.getLinkConstraints()
				.canExistReadWriteInteraction_4006(container, getLink(), source, getNewTarget());
	}
	...
	* @generated
	*/
	protected patternGenerator.ReadWriteInteraction getLink() {
		return (patternGenerator.ReadWriteInteraction) getElementToEdit();
	}
