 ...
 * @generated
 */
public class ReadWriteInteractionCreateCommand extends EditElementCommand {
	...
	* @generated
	*/
	public ReadWriteInteractionCreateCommand(CreateRelationshipRequest request, EObject source, EObject target) {
	...
	*/
	public boolean canExecute() {
		...
		return patternGenerator.diagram.edit.policies.PatternsBaseItemSemanticEditPolicy.getLinkConstraints()
				.canCreateReadWriteInteraction_4006(getContainer(), getSource(), getTarget());
	}
	...
	*/
	protected CommandResult doExecuteWithResult(IProgressMonitor monitor, IAdaptable info) throws ExecutionException {
		...
		patternGenerator.ReadWriteInteraction newElement = patternGenerator.PatternGeneratorFactory.eINSTANCE
				.createReadWriteInteraction();
	...
	* @generated
	*/
	protected void doConfigure(patternGenerator.ReadWriteInteraction newElement, IProgressMonitor monitor,
