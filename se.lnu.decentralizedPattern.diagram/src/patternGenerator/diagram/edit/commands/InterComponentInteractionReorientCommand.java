 ...
 * @generated
 */
public class InterComponentInteractionReorientCommand extends EditElementCommand {
	...
	* @generated
	*/
	public InterComponentInteractionReorientCommand(ReorientRelationshipRequest request) {
	...
	*/
	public boolean canExecute() {
		if (false == getElementToEdit() instanceof patternGenerator.InterComponentInteraction) {
			return false;
		}
	...
	*/
	protected boolean canReorientSource() {
		...
		return patternGenerator.diagram.edit.policies.PatternsBaseItemSemanticEditPolicy.getLinkConstraints()
				.canExistInterComponentInteraction_4002(container, getLink(), getNewSource(), target);
	}
	...
	*/
	protected boolean canReorientTarget() {
		...
		patternGenerator.DecentralizedControlPattern container = (patternGenerator.DecentralizedControlPattern) getLink()
				.eContainer();
		return patternGenerator.diagram.edit.policies.PatternsBaseItemSemanticEditPolicy.getLinkConstraints()
				.canExistInterComponentInteraction_4002(container, getLink(), source, getNewTarget());
	}
	...
	* @generated
	*/
	protected patternGenerator.InterComponentInteraction getLink() {
		return (patternGenerator.InterComponentInteraction) getElementToEdit();
	}
