...
public class PatternGeneratorValidator extends EObjectValidator {
	 ...
	 * @generated
	 */
	protected static final String INTERACTION__TARGET_AND_CONTEXT_DIFFERENT__EEXPRESSION = "\n" +
		"\t\t\t\t\tif(targetAndContextNotNull)\n" +
		"\t\t\t\t\t\tthen self.context <> self.target\n" +
		"\t\t\t\t\telse true\n" +
		"\t\t\t\t\tendif";
	 ...
	 * @generated
	 */
	protected static final String INTRA_COMPONENT_INTERACTION__IS_INTRA_COMPONENT__EEXPRESSION = "\n" +
		"\t\t\tif(targetAndContextNotNull)\n" +
		"\t\t\t\tthen context->oclType() = target->oclType()\n" +
		"\t\t\telse true\n" +
		"\t\t\tendif";
	 ...
	 * @generated
	 */
	protected static final String INTER_COMPONENT_INTERACTION__IS_INTER_COMPONENT__EEXPRESSION = "\n" +
		"\t\t\tif(targetAndContextNotNull)\n" +
		"\t\t\t\tthen context->oclType() <> target->oclType()\n" +
		"\t\t\telse true\n" +
		"\t\t\tendif";
	 ...
	 * @generated
	 */
	protected static final String READ_WRITE_INTERACTION__TARGET_IS_KNOWLEDGE__EEXPRESSION = "self.target.oclIsKindOf(Knowledge)";
	...
	protected static final String COORDINATION__HAS_EXACTLY_ONE_INVERSE__EEXPRESSION = "self.oclContainer().oclAsType(DecentralizedControlPattern).elements\n" +
		...
		"\t\t\t\t\t\t\t\t\t\t->select(oclAsType(Coordination).targetAndContextNotNull) \n" +
	 ...
	 * @generated
	 */
	protected static final String COORDINATION__IS_INVERSE__EEXPRESSION = "self.inverse.target = self.context \n" +
		"\t\tand self.inverse.context = self.target";
