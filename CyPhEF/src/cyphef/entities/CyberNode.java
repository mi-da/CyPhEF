...
* {@link Network}.
*/
public class CyberNode implements Node {
...
* the configuration.
*/
public CyberNode(String prefix) {
...
public Object clone() {
	...
	CyberNode result = null;
	try { result=(CyberNode)super.clone(); }
...
public static CyberNode getNode(long id) {
	for (int i = 0; i < Network.size(); i++) {
		CyberNode n = (CyberNode) Network.get(i);
		if(n.getID()==id)
			return n;
	}
	try {
