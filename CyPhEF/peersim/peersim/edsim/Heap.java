...
public class Heap implements PriorityQ {
	...
	public Heap(String prefix) {
		...
		if (!Configuration.contains(PAR_PBITS_LEGACY))
			...
			if (Configuration.contains(prefix + "." + PAR_PBITS))
				throw new IllegalParameterException(PAR_PBITS_LEGACY, "Your configuration file contains both " + prefix + "." + PAR_PBITS + " and " + PAR_PBITS_LEGACY + "; please remove " + PAR_PBITS_LEGACY);
		}

		if (pbits < 8 || pbits >= 31) {
			throw new IllegalParameterException(prefix + "." + PAR_PBITS, "This parameter should be >= 8 or < 31");
		}
	...
	// Custom
	public Node nextProcessingNode() {
