 ...
 * @generated
 */
public class HPeerNameEditPart extends CompartmentEditPart implements ITextAwareEditPart {
	...
	* @generated
	*/
	public HPeerNameEditPart(View view) {
		super(view);
	}
	...
	public IParser getParser() {
		if (parser == null) {
			parser = patternGenerator.diagram.providers.PatternsParserProvider.getParser(
					patternGenerator.diagram.providers.PatternsElementTypes.HPeer_2010, getParserElement(),
