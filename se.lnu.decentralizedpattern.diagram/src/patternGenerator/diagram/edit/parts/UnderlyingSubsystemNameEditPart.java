 ...
 * @generated
 */
public class UnderlyingSubsystemNameEditPart extends CompartmentEditPart implements ITextAwareEditPart {
	...
	* @generated
	*/
	public UnderlyingSubsystemNameEditPart(View view) {
		super(view);
	}
	...
	public IParser getParser() {
		if (parser == null) {
			parser = patternGenerator.diagram.providers.PatternsParserProvider.getParser(
					...
					getParserElement(), patternGenerator.diagram.part.PatternsVisualIDRegistry
