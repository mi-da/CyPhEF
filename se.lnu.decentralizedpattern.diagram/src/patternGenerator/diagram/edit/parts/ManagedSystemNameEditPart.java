 ...
 * @generated
 */
public class ManagedSystemNameEditPart extends CompartmentEditPart implements ITextAwareEditPart {
	...
	* @generated
	*/
	public ManagedSystemNameEditPart(View view) {
		super(view);
	}
	...
	public IParser getParser() {
		if (parser == null) {
			parser = patternGenerator.diagram.providers.PatternsParserProvider.getParser(
					patternGenerator.diagram.providers.PatternsElementTypes.ManagedSystem_2009, getParserElement(),
