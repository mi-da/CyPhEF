...
public class NodeCreateCommand extends EditElementCommand {
	...
	*/
	protected CommandResult doExecuteWithResult(IProgressMonitor monitor, IAdaptable info) throws ExecutionException {
		patternGenerator.decentralizedPattern.Node newElement = patternGenerator.decentralizedPattern.DecentralizedPatternFactory.eINSTANCE
				.createNode();
	...
	* @generated
	*/
	protected void doConfigure(patternGenerator.decentralizedPattern.Node newElement, IProgressMonitor monitor,
