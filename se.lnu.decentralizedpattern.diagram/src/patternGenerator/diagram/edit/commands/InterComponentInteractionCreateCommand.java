 ...
 * @generated
 */
public class InterComponentInteractionCreateCommand extends EditElementCommand {
	...
	* @generated
	*/
	public InterComponentInteractionCreateCommand(CreateRelationshipRequest request, EObject source, EObject target) {
	...
	*/
	public boolean canExecute() {
		...
		return patternGenerator.diagram.edit.policies.PatternsBaseItemSemanticEditPolicy.getLinkConstraints()
				.canCreateInterComponentInteraction_4002(getContainer(), getSource(), getTarget());
	}
	...
	*/
	protected CommandResult doExecuteWithResult(IProgressMonitor monitor, IAdaptable info) throws ExecutionException {
		...
		patternGenerator.InterComponentInteraction newElement = patternGenerator.PatternGeneratorFactory.eINSTANCE
	...
	* @generated
	*/
	protected void doConfigure(patternGenerator.InterComponentInteraction newElement, IProgressMonitor monitor,
