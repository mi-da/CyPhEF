...
public class DelegationReorientCommand extends EditElementCommand {
	...
	*/
	public boolean canExecute() {
		if (false == getElementToEdit() instanceof patternGenerator.Delegation) {
			return false;
		}
	...
	*/
	protected boolean canReorientSource() {
		...
		return patternGenerator.diagram.edit.policies.PatternsBaseItemSemanticEditPolicy.getLinkConstraints()
				.canExistDelegation_4004(container, getLink(), getNewSource(), target);
	}
	...
	*/
	protected boolean canReorientTarget() {
		...
		patternGenerator.DecentralizedControlPattern container = (patternGenerator.DecentralizedControlPattern) getLink()
				.eContainer();
		return patternGenerator.diagram.edit.policies.PatternsBaseItemSemanticEditPolicy.getLinkConstraints()
				.canExistDelegation_4004(container, getLink(), source, getNewTarget());
	}
	...
	* @generated
	*/
	protected patternGenerator.Delegation getLink() {
		return (patternGenerator.Delegation) getElementToEdit();
	}
