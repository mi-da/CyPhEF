...
public class DelegationCreateCommand extends EditElementCommand {
	...
	*/
	public boolean canExecute() {
		...
		return patternGenerator.diagram.edit.policies.PatternsBaseItemSemanticEditPolicy.getLinkConstraints()
				.canCreateDelegation_4004(getContainer(), getSource(), getTarget());
	}
	...
	*/
	protected CommandResult doExecuteWithResult(IProgressMonitor monitor, IAdaptable info) throws ExecutionException {
		...
		patternGenerator.Delegation newElement = patternGenerator.PatternGeneratorFactory.eINSTANCE.createDelegation();
	...
	* @generated
	*/
	protected void doConfigure(patternGenerator.Delegation newElement, IProgressMonitor monitor, IAdaptable info)
