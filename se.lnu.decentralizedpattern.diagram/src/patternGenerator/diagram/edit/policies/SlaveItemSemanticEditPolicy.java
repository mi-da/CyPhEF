 ...
 * @generated
 */
public class SlaveItemSemanticEditPolicy
	...
	*/
	public SlaveItemSemanticEditPolicy() {
		super(patternGenerator.diagram.providers.PatternsElementTypes.Slave_2001);
	}
	...
	*/
	protected Command getCreateCommand(CreateElementRequest req) {
		if (patternGenerator.diagram.providers.PatternsElementTypes.Monitor_3001 == req.getElementType()) {
			return getGEFWrapper(new patternGenerator.diagram.edit.commands.MonitorCreateCommand(req));
		}
		if (patternGenerator.diagram.providers.PatternsElementTypes.Execute_3002 == req.getElementType()) {
			return getGEFWrapper(new patternGenerator.diagram.edit.commands.ExecuteCreateCommand(req));
		}
