...
public class NodeItemSemanticEditPolicy
	...
	*/
	public NodeItemSemanticEditPolicy() {
		super(patternGenerator.diagram.providers.PatternsElementTypes.Node_2006);
	}
	...
	*/
	protected Command getCreateCommand(CreateElementRequest req) {
		if (patternGenerator.diagram.providers.PatternsElementTypes.Monitor_3012 == req.getElementType()) {
			return getGEFWrapper(new patternGenerator.diagram.edit.commands.Monitor3CreateCommand(req));
		}
		if (patternGenerator.diagram.providers.PatternsElementTypes.Analyze_3013 == req.getElementType()) {
			return getGEFWrapper(new patternGenerator.diagram.edit.commands.Analyze3CreateCommand(req));
		}
		if (patternGenerator.diagram.providers.PatternsElementTypes.Plan_3014 == req.getElementType()) {
			return getGEFWrapper(new patternGenerator.diagram.edit.commands.Plan4CreateCommand(req));
		}
		if (patternGenerator.diagram.providers.PatternsElementTypes.Execute_3015 == req.getElementType()) {
			return getGEFWrapper(new patternGenerator.diagram.edit.commands.Execute3CreateCommand(req));
		}
		if (patternGenerator.diagram.providers.PatternsElementTypes.Knowledge_3016 == req.getElementType()) {
			return getGEFWrapper(new patternGenerator.diagram.edit.commands.Knowledge3CreateCommand(req));
		}
