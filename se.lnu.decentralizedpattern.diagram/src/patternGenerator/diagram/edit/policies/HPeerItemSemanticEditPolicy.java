 ...
 * @generated
 */
public class HPeerItemSemanticEditPolicy
		extends patternGenerator.diagram.edit.policies.PatternsBaseItemSemanticEditPolicy {

	/**
	* @generated
	*/
	public HPeerItemSemanticEditPolicy() {
		super(patternGenerator.diagram.providers.PatternsElementTypes.HPeer_2010);
	}
	...
	*/
	protected Command getCreateCommand(CreateElementRequest req) {
		if (patternGenerator.diagram.providers.PatternsElementTypes.Monitor_3020 == req.getElementType()) {
			return getGEFWrapper(new patternGenerator.diagram.edit.commands.Monitor5CreateCommand(req));
		}
		if (patternGenerator.diagram.providers.PatternsElementTypes.Analyze_3021 == req.getElementType()) {
			return getGEFWrapper(new patternGenerator.diagram.edit.commands.Analyze5CreateCommand(req));
		}
		if (patternGenerator.diagram.providers.PatternsElementTypes.Plan_3022 == req.getElementType()) {
			return getGEFWrapper(new patternGenerator.diagram.edit.commands.Plan5CreateCommand(req));
		}
		if (patternGenerator.diagram.providers.PatternsElementTypes.Execute_3023 == req.getElementType()) {
			return getGEFWrapper(new patternGenerator.diagram.edit.commands.Execute5CreateCommand(req));
		}
