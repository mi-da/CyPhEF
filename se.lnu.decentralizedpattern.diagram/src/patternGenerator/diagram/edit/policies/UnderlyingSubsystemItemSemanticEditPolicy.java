 ...
 * @generated
 */
public class UnderlyingSubsystemItemSemanticEditPolicy
		extends patternGenerator.diagram.edit.policies.PatternsBaseItemSemanticEditPolicy {

	/**
	* @generated
	*/
	public UnderlyingSubsystemItemSemanticEditPolicy() {
		super(patternGenerator.diagram.providers.PatternsElementTypes.UnderlyingSubsystem_2007);
	}
	...
	*/
	protected Command getCreateCommand(CreateElementRequest req) {
		if (patternGenerator.diagram.providers.PatternsElementTypes.Monitor_3017 == req.getElementType()) {
			return getGEFWrapper(new patternGenerator.diagram.edit.commands.Monitor4CreateCommand(req));
		}
		if (patternGenerator.diagram.providers.PatternsElementTypes.Analyze_3018 == req.getElementType()) {
			return getGEFWrapper(new patternGenerator.diagram.edit.commands.Analyze4CreateCommand(req));
		}
		if (patternGenerator.diagram.providers.PatternsElementTypes.Execute_3019 == req.getElementType()) {
			return getGEFWrapper(new patternGenerator.diagram.edit.commands.Execute4CreateCommand(req));
		}
