 ...
 * @generated
 */
public class PatternsModelingAssistantProviderOfKnowledge3EditPart
	...
	*/
	...
	public List<IElementType> getRelTypesOnSource(IAdaptable source) {
		...
		return doGetRelTypesOnSource((patternGenerator.diagram.edit.parts.Knowledge3EditPart) sourceEditPart);
	}

	/**
	* @generated
	*/
	public List<IElementType> doGetRelTypesOnSource(patternGenerator.diagram.edit.parts.Knowledge3EditPart source) {
	...
	*/
	...
	public List<IElementType> getRelTypesOnSourceAndTarget(IAdaptable source, IAdaptable target) {
		...
		return doGetRelTypesOnSourceAndTarget((patternGenerator.diagram.edit.parts.Knowledge3EditPart) sourceEditPart,
				targetEditPart);
	}
	...
	*/
	public List<IElementType> doGetRelTypesOnSourceAndTarget(
			patternGenerator.diagram.edit.parts.Knowledge3EditPart source, IGraphicalEditPart targetEditPart) {
	...
	*/
	...
	public List<IElementType> getTypesForTarget(IAdaptable source, IElementType relationshipType) {
		IGraphicalEditPart sourceEditPart = (IGraphicalEditPart) source.getAdapter(IGraphicalEditPart.class);
		return doGetTypesForTarget((patternGenerator.diagram.edit.parts.Knowledge3EditPart) sourceEditPart,
				relationshipType);
	}
	...
	* @generated
	*/
	public List<IElementType> doGetTypesForTarget(patternGenerator.diagram.edit.parts.Knowledge3EditPart source,
	...
	*/
	...
	public List<IElementType> getRelTypesOnTarget(IAdaptable target) {
		IGraphicalEditPart targetEditPart = (IGraphicalEditPart) target.getAdapter(IGraphicalEditPart.class);
		return doGetRelTypesOnTarget((patternGenerator.diagram.edit.parts.Knowledge3EditPart) targetEditPart);
	}

	/**
	* @generated
	*/
	public List<IElementType> doGetRelTypesOnTarget(patternGenerator.diagram.edit.parts.Knowledge3EditPart target) {
		List<IElementType> types = new ArrayList<IElementType>(4);
		types.add(patternGenerator.diagram.providers.PatternsElementTypes.InterComponentInteraction_4002);
		types.add(patternGenerator.diagram.providers.PatternsElementTypes.Coordination_4003);
		types.add(patternGenerator.diagram.providers.PatternsElementTypes.Delegation_4004);
	...
	*/
	...
	public List<IElementType> getTypesForSource(IAdaptable target, IElementType relationshipType) {
		IGraphicalEditPart targetEditPart = (IGraphicalEditPart) target.getAdapter(IGraphicalEditPart.class);
		return doGetTypesForSource((patternGenerator.diagram.edit.parts.Knowledge3EditPart) targetEditPart,
				relationshipType);
	}
	...
	* @generated
	*/
	public List<IElementType> doGetTypesForSource(patternGenerator.diagram.edit.parts.Knowledge3EditPart target,
			IElementType relationshipType) {
		List<IElementType> types = new ArrayList<IElementType>();
		if (relationshipType == patternGenerator.diagram.providers.PatternsElementTypes.InterComponentInteraction_4002) {
			types.add(patternGenerator.diagram.providers.PatternsElementTypes.Monitor_3001);
