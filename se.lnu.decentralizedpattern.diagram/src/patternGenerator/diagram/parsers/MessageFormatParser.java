...
package patternGenerator.diagram.parsers;
...
public class MessageFormatParser extends AbstractAttributeParser {
	...
	*/
	public IParserEditStatus isValidEditString(IAdaptable adapter, String editString) {
		...
		if (values == null) {
			return new ParserEditStatus(patternGenerator.diagram.part.PatternsDiagramEditorPlugin.ID,
					IParserEditStatus.UNEDITABLE,
					NLS.bind(patternGenerator.diagram.part.Messages.MessageFormatParser_InvalidInputError,
